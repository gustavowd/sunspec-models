...
pub fn model707() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripLV.Crv.MayTrip.Pt.Tms", offset: 14+2, length: 1, write_access: true, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripLV.Crv.MomCess.Pt.Tms", offset: 18+2, length: 1, write_access: true, value: 0xFFFFFFFF } ));
