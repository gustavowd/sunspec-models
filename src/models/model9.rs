...
pub fn model9() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "CertUID", offset: 2, length: 1, write_access: true, value: 0xFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "Ts", offset: 84+2, length: 2, write_access: true, value: 0xFFFFFFFF } ));
