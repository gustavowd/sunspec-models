...
pub fn model710() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripHF.Crv.MustTrip.Pt.Tms", offset: 11+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "DERTripHF.Crv.MayTrip.ActPt", offset: 13+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripHF.Crv.MayTrip.Pt.Hz", offset: 14+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripHF.Crv.MayTrip.Pt.Tms", offset: 16+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "DERTripHF.Crv.MomCess.ActPt", offset: 18+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripHF.Crv.MomCess.Pt.Hz", offset: 19+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "DERTripHF.Crv.MomCess.Pt.Tms", offset: 21+2, length: 1, write_access: true, value: 0 } ));
