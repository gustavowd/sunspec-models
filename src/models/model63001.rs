...
pub fn model63001() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_1", offset: 22+2, length: 1, write_access: false, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_2", offset: 24+2, length: 1, write_access: false, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_3", offset: 26+2, length: 1, write_access: true, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_4", offset: 28+2, length: 1, write_access: false, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_5", offset: 30+2, length: 1, write_access: false, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "int32_u", offset: 32+2, length: 1, write_access: false, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_1", offset: 34+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_2", offset: 36+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_3", offset: 38+2, length: 1, write_access: true, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_4", offset: 40+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_5", offset: 42+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "uint32_u", offset: 44+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "enum32", offset: 50+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "enum32_u", offset: 52+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "bitfield32", offset: 54+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "bitfield32_u", offset: 56+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecI64(Point { name: "int64", offset: 62+2, length: 1, write_access: true, value: -9223372036854775808i64 } ));
    ret.data.push(DataTypes::SunspecI64(Point { name: "int64_u", offset: 66+2, length: 1, write_access: false, value: -9223372036854775808i64 } ));
