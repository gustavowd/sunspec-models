...
pub fn model804() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "St", offset: 2+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "NCyc", offset: 8+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "ConSt", offset: 24+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "Evt1", offset: 26+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "Evt2", offset: 28+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "EvtVnd1", offset: 30+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "EvtVnd2", offset: 32+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
