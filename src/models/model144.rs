...
pub fn model144() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "Tms_SF", offset: 7+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "Hz_SF", offset: 8+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "CrvType", offset: 9+2, length: 1, write_access: false, value: 0 } ));
