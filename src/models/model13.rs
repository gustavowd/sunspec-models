...
pub fn model13() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "CfgSt", offset: 4+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "ChgSt", offset: 5+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Cap", offset: 6+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Cfg", offset: 7+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Ctl", offset: 8+2, length: 1, write_access: true, value: 0 } ));
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "Pad", offset: 173+2, length: 1, write_access: false, value: 0 } ));
