...
pub fn model16() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "Cfg", offset: 4+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Ctl", offset: 5+2, length: 1, write_access: true, value: 0 } ));
    ...
    ret.data.push(DataTypes::SunspecU64(Point { name: "MAC", offset: 46+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "LnkCtl", offset: 50+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Pad", offset: 51+2, length: 1, write_access: false, value: 0 } ));
