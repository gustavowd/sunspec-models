...
pub fn model401() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "DCA", offset: 9+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "DCAhr", offset: 10+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "DCV", offset: 12+2, length: 1, write_access: false, value: 0 } ));
