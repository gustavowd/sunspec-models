...
pub fn model140() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "V_SF", offset: 8+2, length: 1, write_access: false, value: -32768i16 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "CrvType", offset: 9+2, length: 1, write_access: false, value: 0xFFFF } ));
