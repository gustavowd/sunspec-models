...
pub fn model805() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "StrIdx", offset: 0+2, length: 1, write_access: false, value: 0xFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "NCyc", offset: 6+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
