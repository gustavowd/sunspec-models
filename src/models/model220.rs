...
pub fn model220() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "Evt", offset: 33+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "Rsrvd", offset: 35+2, length: 1, write_access: false, value: 0x8000 } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "Ts", offset: 36+2, length: 1, write_access: false, value: 0xFFFFFFFF } ));
