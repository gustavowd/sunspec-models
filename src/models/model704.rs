...
pub fn model704() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "PFWAbsRvrtTms", offset: 8+2, length: 2, write_access: true, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "PFWAbsRvrtRem", offset: 10+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "WMaxLimPctRvrtTms", offset: 16+2, length: 2, write_access: true, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "WMaxLimPctRvrtRem", offset: 18+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecI32(Point { name: "WSet", offset: 22+2, length: 2, write_access: true, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "WSetRvrt", offset: 24+2, length: 2, write_access: true, value: -2147483648i32 } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "WSetRvrtTms", offset: 29+2, length: 2, write_access: true, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "WSetRvrtRem", offset: 31+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
    ...
    ret.data.push(DataTypes::SunspecI32(Point { name: "VarSet", offset: 36+2, length: 2, write_access: true, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "VarSetRvrt", offset: 38+2, length: 2, write_access: true, value: -2147483648i32 } ));
    ...
    ret.data.push(DataTypes::SunspecU32(Point { name: "VarSetRvrtTms", offset: 43+2, length: 2, write_access: true, value: 0xFFFFFFFF } ));
    ret.data.push(DataTypes::SunspecU32(Point { name: "VarSetRvrtRem", offset: 45+2, length: 2, write_access: false, value: 0xFFFFFFFF } ));
