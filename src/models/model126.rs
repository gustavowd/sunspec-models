...
pub fn model126() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "V_SF", offset: 7+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "DeptRef_SF", offset: 8+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "RmpIncDec_SF", offset: 9+2, length: 1, write_access: false, value: 0 } ));
