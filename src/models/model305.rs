...
pub fn model305() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI32(Point { name: "Lat", offset: 30+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "Long", offset: 32+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "Alt", offset: 34+2, length: 1, write_access: false, value: 0 } ));
