...
pub fn model122() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "VArAval_SF", offset: 28+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "WAval", offset: 29+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecU16(Point { name: "WAval_SF", offset: 30+2, length: 1, write_access: false, value: 0 } ));
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "Ris_SF", offset: 43+2, length: 1, write_access: false, value: 0 } ));
