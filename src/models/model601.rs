...
pub fn model601() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI32(Point { name: "GlblElCtl", offset: 18+2, length: 1, write_access: true, value: -2147483648i32 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "GlblAzCtl", offset: 20+2, length: 1, write_access: true, value: -2147483648i32 } ));
