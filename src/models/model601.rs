...
pub fn model601() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "Typ", offset: 8+2, length: 1, write_access: false, value: 0 } ));
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "Day", offset: 17+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI32(Point { name: "GlblElCtl", offset: 18+2, length: 1, write_access: true, value: 0 } ));
