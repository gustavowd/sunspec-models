...
pub fn model711() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "Db_SF", offset: 9+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "K_SF", offset: 10+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "RspTms_SF", offset: 11+2, length: 1, write_access: false, value: 0 } ));
