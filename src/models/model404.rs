...
pub fn model404() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "DCW_SF", offset: 3+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "DCWh_SF", offset: 4+2, length: 1, write_access: false, value: 0 } ));
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "InDCA_SF", offset: 20+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "InDCAhr_SF", offset: 21+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "InDCV_SF", offset: 22+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "InDCW_SF", offset: 23+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "InDCWh_SF", offset: 24+2, length: 1, write_access: false, value: 0 } ));
