...
pub fn model134() -> Model {
    ...
    ret.data.push(DataTypes::SunspecI16(Point { name: "Hz_SF", offset: 7+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "W_SF", offset: 8+2, length: 1, write_access: false, value: 0 } ));
