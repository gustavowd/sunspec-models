...
pub fn model712() -> Model {
    ...
    ret.data.push(DataTypes::SunspecU16(Point { name: "DERWattVar.Crv.ReadOnly", offset: 15+2, length: 1, write_access: false, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "DERWattVar.Crv.Pt.W", offset: 16+2, length: 1, write_access: true, value: 0 } ));
    ret.data.push(DataTypes::SunspecI16(Point { name: "DERWattVar.Crv.Pt.Var", offset: 17+2, length: 1, write_access: true, value: 0 } ));
